...
declare namespace $ {
    const $bog_prof_theme: Record<"image" | "line" | "text" | "field" | "focus" | "back" | "hover" | "card" | "current" | "special" | "control" | "shade" | "spirit", $mol_style_func<"var", unknown>>;
}
...
declare namespace $ {
	...
	export class $bog_prof_theme_auto extends $mol_theme_auto {
		light( ): string
		dark( ): string
	}
